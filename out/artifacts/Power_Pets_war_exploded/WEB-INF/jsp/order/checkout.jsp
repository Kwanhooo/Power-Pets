        ...
        <div class="checkoutContent" style="">
            <div class="col-md-12 column">
                <div class="page-header">
                    ...
                    <i style="font-size:18px;color: grey;">&nbsp;当前 <strong><span id="category-span" style="right: 50px;font-size:20px;color: grey;">您正在创建订单</span></strong></i>
                </div>
            </div>
            ...
            <form action="order" method="post">
                <div class="row clearfix">
                    ...
                    <div style="position:fixed;top:400px;right: 400px;background-color:#eeeeee;border-radius:30px;width: 470px;height:250px;">
                        ...
                        <br>
                        <button type="button" class="btn btn-lg btn-primary" id="address-book-checkout-btn" style="margin-left: 20px;width:200px;">选取你的地址</button>
                    </div>
