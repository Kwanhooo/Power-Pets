    ...
    <div class="mainContent">
        <div class="accountContent">
            <div class="container">
                ...
                <div class="row clearfix">
                    <div class="col-md-8 column">
                        ...
                        <%
                            ...
                            out.print("<strong>收货人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>");out.print("<input type=\"text\" name=\"consignee\" value=\"");out.print(consignee);out.print("\"><br><br>");
                            out.print("<strong>省市地址 &nbsp;&nbsp;&nbsp;&nbsp;</strong>");out.print("<input type=\"text\" name=\"city\" value=\"");out.print(city);out.print("\"><br><br>");
                            out.print("<strong>详细地址 &nbsp;&nbsp;&nbsp;&nbsp;</strong>");out.print("<input type=\"text\" name=\"address\" value=\"");out.print(address);out.print("\"><br><br>");
                            out.print("<strong>联系电话 &nbsp;&nbsp;&nbsp;&nbsp;</strong>");out.print("<input type=\"text\" name=\"contact\" value=\"");out.print(contact);out.print("\"><br><br>");
                        %>
                    </div>
                    <div class="col-md-4 column">
                        <h3 style="font-family: var(--font-family-sans-serif);">
                ...
                <div class="row clearfix">
                    <div class="col-md-12 column">
                        <button class="btn btn-lg btn-danger btn-block" style="max-width: 90%;margin-top: 10px;">确认修改</button>
                    </div>
                </div>
                </form>
            </div>
